...
def setup_scheduler():
    ...
    scheduler.add_job(
        crawl_latest,
        CronTrigger(day_of_week='tue,thu,sun', hour=23, minute=0),
        id='crawl_latest',
        name='爬取最新开奖数据'
    )
    ...
    scheduler.add_job(
        auto_predict,
        CronTrigger(day_of_week='tue,thu,sun', hour=23, minute=59),
        id='auto_predict',
        name='自动生成预测'
    )
    ...
    scheduler.add_job(
        check_hits,
        CronTrigger(day_of_week='tue,thu,sun', hour=23, minute=10),
        id='check_hits',
        name='检查预测中奖'
    )
